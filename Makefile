...
$(STAGING_DIR):
	...
	@mkdir -p "$(join $(STAGING_DIR), libexec/container/plugins/container-network-gvnet/bin)"
	...
	@install "$(BUILD_BIN_DIR)/container-network-gvnet" "$(join $(STAGING_DIR), libexec/container/plugins/container-network-gvnet/bin/container-network-gvnet)"
	@install Sources/Plugins/NetworkGvnet/config.toml "$(join $(STAGING_DIR), libexec/container/plugins/container-network-gvnet/config.toml)"
